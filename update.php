...
$counter = 0;
$start_time = time();
$stmt = db_query_resultset("SELECT id, ip, continent_code, country_code, country_code3, country_name, region, city, postal_code, latitude, longitude, dma_code, area_code FROM ip_info");
